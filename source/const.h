...
enum MagicEffectClasses {
	...
	NM_ME_ICEAREA		   = 0x19, //25
	NM_ME_ICEATTACK		   = 0x1A, //26
	NM_ME_GROUNDSHAKER	   = 0x1B, //27
	NM_ME_FIREATTACK	   = 0x1C, //28
	NM_ME_SMALLCLOUDS	   = 0x1D, //29
	NM_ME_PURPLEENERGY     = 0x1E, //30
	NM_ME_YELLOWENERGY     = 0x1F, //31
	NM_ME_HOLYDAMAGE	   = 0x20, //32
	NM_ME_SMALLPLANTS	   = 0x21, //33
	NM_ME_HOLYAREA		   = 0x22, //34
	NM_ME_ICETORNADO	   = 0x23, //35
	NM_ME_BUBBLES		   = 0x24, //36
	NM_ME_STUN			   = 0x25, //37
	NM_ME_STONES		   = 0x26, //38
	NM_ME_BIGPLANTS		   = 0x27, //39
	NM_ME_PLANTATTACK	   = 0x28, //40
	NM_ME_CRAPS			   = 0x29, //41
	NM_ME_HEARTS		   = 0x2A, //42
	NM_ME_CARNIPHILA	   = 0x2B, //43
	NM_ME_WATERSPLASH	   = 0x2C, //44
...
enum ShootType_t {
	...
	NM_SHOOT_REDSTAR		= 0x10, //16
	NM_SHOOT_ROYALSPEAR     = 0x11, //17
	NM_SHOOT_ONYXARROW		= 0x12, //18
	NM_SHOOT_GREENSTAR		= 0x13, //19
	NM_SHOOT_SNIPERARROW	= 0x14, //20
	NM_SHOOT_PIERCINGBOLT	= 0x15, //21
	NM_SHOOT_WHIRLWINDAXE	= 0x16, //22
	NM_SHOOT_ICE			= 0x17, //23
	NM_SHOOT_FLAMINGARROW	= 0x18, //24	
	NM_SHOOT_SMALLICE		= 0x19, //25
	NM_SHOOT_SMALLEARTH		= 0x1A, //26
	NM_SHOOT_PRISMATICBOLT	= 0x1B, //27
	NM_SHOOT_CRYSTALINEARROW = 0x1C, //28
	NM_SHOOT_DRILLBOLT		= 0x1D, //29
	NM_SHOOT_ENVENOMEDARROW	= 0x1E, //30
	NM_SHOOT_WHIRLWINDCLUB	= 0x1F, //31
	NM_SHOOT_WHIRLWINDSWORD	= 0x20, //32
	NM_SHOOT_EARTH			= 0x21, //33
	NM_SHOOT_VORTEXBOLT		= 0x22, //34
	NM_SHOOT_ETHEREALSPEAR	= 0x23, //35
	NM_SHOOT_HOLY			= 0x24, //36
